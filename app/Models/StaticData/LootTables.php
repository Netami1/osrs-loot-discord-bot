    ...
    public function data(): array
    {
        return [
            ...
            LootSources::EASY_CLUE_ID => [
                [
                    'id' => self::EASY_CLUE_PRIMARY_ID,
                    'type' => LootTypeEnum::PRIMARY,
                    'rolls_min' => 2,
                    'rolls_max' => 4,
                ],
                [
                    'id' => self::EASY_CLUE_TERTIARY_ID,
                    'type' => LootTypeEnum::TERTIARY,
                ],
            ],
            ...
            LootSources::HARD_CLUE_ID => [
                [
                    'id' => self::HARD_CLUE_PRIMARY_ID,
                    'type' => LootTypeEnum::PRIMARY,
                    'rolls_min' => 4,
                    'rolls_max' => 6,
                ],
                [
                    'id' => self::HARD_CLUE_TERTIARY_ID,
                    'type' => LootTypeEnum::TERTIARY,
                ],
            ],
            ...
            LootSources::MASTER_CLUE_ID => [
                [
                    'id' => self::MASTER_CLUE_PRIMARY_ID,
                    'type' => LootTypeEnum::PRIMARY,
                    'rolls_min' => 5,
                    'rolls_max' => 7,
                ],
